        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserIdFollowed = table.Column<int>(type: "integer", nullable: false),
                    UserIdFollowing = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Followers_Users_UserIdFollowed",
                        column: x => x.UserIdFollowed,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Followers_Users_UserIdFollowing",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    TriggerById = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Users_TriggerById",
                        column: x => x.TriggerById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Followers_UserIdFollowed",
                table: "Followers",
                column: "UserIdFollowed");

            migrationBuilder.CreateIndex(
                name: "IX_Followers_UserIdFollowing_UserIdFollowed",
                table: "Followers",
                columns: new[] { "UserIdFollowing", "UserIdFollowed" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_TriggerById",
                table: "Notifications",
                column: "TriggerById");
