        ...
        <Link href={`/stories/${story.username}/${story.id}`} className="text-decoration-none text-body">
            ...
            >
                <div className="p-1 circle-element rounded-circle rainbow-border position-relative">
                    <img
                        src={story.profilePictureUrl ? BASE_URL + story.profilePictureUrl : "https://cdn-icons-png.flaticon.com/512/6522/6522516.png"}
                        alt={`Foto de perfil de ${story.username}`}
                        className="rounded-circle"
                        style={{ width: "62px", height: "62px", objectFit: "cover", border: "2px solid var(--bs-body-bg)" }}
                    />
                </div>
