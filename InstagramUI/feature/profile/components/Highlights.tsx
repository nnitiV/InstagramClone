...
export default function Highlights() {
    return (
        <div className="profile-highlights mt-5 w-75 mx-auto d-flex overflow-x-scroll">
            {USER_PROFILE_MOCK.highlights.map((highlight, _) => (
                <div key={highlight.id} className="transparent-background-hover-2 d-flex flex-column text-center me-3 cursor-pointer" style={{ width: "fit-content" }}>
