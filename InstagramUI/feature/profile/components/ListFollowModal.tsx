...
type ListFollowModalProps = {
    users: Follower[];
    userId: number | undefined
}

export default function ListFollowModal({ users, userId }: ListFollowModalProps) {
    ...
    return (
        <div className="modal fade" id="listFollowModal" tabIndex={-1} aria-labelledby="listFollowModalLabel" aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="listFollowModalLabel">List of </h1>
