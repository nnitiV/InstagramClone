        ...
        <div className={`profile-header d-flex align-items-center w-75 mx-auto my-3 ${isMobile && "flex-column"}`}>
            ...
            <div className="user-info">
                ...
                <div className="user-sub-info d-flex my-2">
                    ...
                    <p className="m-0 p-0 mx-3" style={{ fontSize: ".75rem" }} > <span className="fw-bold m">{userProfile?.followersCount}</span> followers</p>
                    <p className="m-0 p-0" style={{ fontSize: ".75rem" }} > <span className="fw-bold m">{userProfile?.followingCount}</span> following</p>
                </div>
