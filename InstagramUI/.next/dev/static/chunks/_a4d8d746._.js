...
function SearchPage({ params }) {
    ...
    const [isSelf, setIsSelf] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
        ...
        "SearchPage.useEffect": ()=>{
            ...
            const getUser = {
                "SearchPage.useEffect.getUser": async ()=>{
                    let userFetched = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$feature$2f$profile$2f$services$2f$profile$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserByUsername"])(username)).user;
                    if (userFetched) setUser(userFetched);
                    const userInfo = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$feature$2f$auth$2f$services$2f$data$3a$b329bb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getLoggedUserInfo"])();
                    if (userInfo.id == userFetched.id) {
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])("/profile");
                    }
                    setIsSelf(userInfo.id == userFetched.id);
                    let userPosts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$feature$2f$profile$2f$services$2f$profile$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserPosts"])(userFetched.id);
                ...
                const checkFollowing = {
                    "SearchPage.useEffect.checkFollowing": async ()=>{
                        ...
                        if (userInfo.id != user.id) {
                            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$feature$2f$profile$2f$services$2f$profile$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkFollowStatus"])(user.id);
    ...
    const followButtonAction = async ()=>{
        ...
        if (user != null) {
            if (isFollowing) {
                didChange = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$feature$2f$profile$2f$services$2f$profile$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unfollowUser"])(user.id);
            } else {
                didChange = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$feature$2f$profile$2f$services$2f$profile$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["followUser"])(user.id);
            }
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: !isSelf && (isFollowing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
...
//# sourceMappingURL=_a4d8d746._.js.map