    ...
    const handleSendMessage = async (e)=>{
        if (e.key == "Enter") {
            if (message.length > 0) {
                ...
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$InstagramUI$2f$feature$2f$message$2f$services$2f$profile$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendMessage"])(messageToSend);
                if (res) {
                    setMessage("");
                    setChat((prev)=>[
                            ...prev,
...
_s(MessageContentPage, "JJ2dScIazvs9vJqUfUBbA0PzX5k=");
...
//# sourceMappingURL=InstagramUI_44764aa9._.js.map